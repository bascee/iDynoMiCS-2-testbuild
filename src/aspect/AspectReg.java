...
public class AspectReg
{
	...
	public Object getValue( AspectInterface rootRegistry, String key) {
		return getValue( rootRegistry, key, true);
	}

	public Object getValue( AspectInterface rootRegistry, String key, boolean interruptOnNull ) {
		Object out = getValueInternal( rootRegistry, key );
		if( interruptOnNull && out == null)
			Idynomics.simulator.interupt("Missing aspect: " + key);
		return out;
	}
	@SuppressWarnings("unchecked")
	private Object getValueInternal( AspectInterface rootRegistry, String key )
	{
		/*
		...
		if ( a == null )
			...
			case PRIMARY:
				return a.aspect;
			case CALCULATED:
				return a.calc.get(rootRegistry);
